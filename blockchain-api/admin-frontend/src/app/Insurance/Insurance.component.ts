...
export class InsuranceComponent implements OnInit {
  ...
  addParticipant(form: any): Promise<any> {
    ...
    return this.serviceInsurance.addParticipant(this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceInsurance.updateParticipant(form.get('insuranceId').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  deleteParticipant(): Promise<any> {
    ...
    return this.serviceInsurance.deleteParticipant(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceInsurance.getparticipant(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
      ...
      if (result.clients) {
        formObject.clients = result.clients;
      } else {
        formObject.clients = null;
      }
