...
export class PatientInfoComponent implements OnInit {
  ...
  patientInfoId = new FormControl('', Validators.required);
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      $class: 'api.PatientInfo',
      'patientInfoId': this.patientInfoId.value,
  ...
  updateAsset(form: any): Promise<any> {
    ...
    return this.servicePatientInfo.updateAsset(form.get('patientInfoId').value, this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.patientInfoId) {
        formObject.patientInfoId = result.patientInfoId;
      } else {
        formObject.patientInfoId = null;
      }
